...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/proposer-un-lieu`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/soutenir`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/presentation`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
  ...
  return [...staticPages, ...sessionPages, ...candidatePages, ...blogPages]
}
